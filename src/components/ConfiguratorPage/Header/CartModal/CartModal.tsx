      ...
      const response = await fetch('/api/create-checkout-session', {
        ...
        body: JSON.stringify({
          cartItems: cart.map(item => ({
            ...
            handlebarType: PARAMETER_DEFINITIONS.find(param => param.id === 'handlebarType')?.options?.find(option => option.value === item.configs.find(config => config.name === 'Handlebar')?.path)?.label,
            ...
            frontWheelType: PARAMETER_DEFINITIONS.find(param => param.id === 'frontWheelType')?.options?.find(option => option.value === item.configs.find(config => config.name === 'Front Wheel')?.path)?.label,
            frontWheelColor: item.configs.find(config => config.name === 'Front Wheel')?.subParts.find(part => part.name === 'rim')?.color.label,
            rearWheelType: PARAMETER_DEFINITIONS.find(param => param.id === 'rearWheelType')?.options?.find(option => option.value === item.configs.find(config => config.name === 'Rear Wheel')?.path)?.label,
            ...
            pedalType: PARAMETER_DEFINITIONS.find(param => param.id === 'pedalType')?.options?.find(option => option.value === item.configs.find(config => config.name === 'Pedals')?.path)?.label,
